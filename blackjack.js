...
clearTimeout(showCards());
    ...
    function renderCard(ele, sender, type, item){
        ...
        $('#hit').om('click', function(){
            player.hit();
        })

        $('#stand').om('click', function(){
            player.stand();
        })

        $('#double').om('click', function(){
            player.dbl();
        })
        
        $('#split').om('click', function(){
            player.split();
        })

        $('#insurance').om('click', function(){
            player.insure();
        })
